...
How Points are Earned:Every task completed (approved via Pull Request) is assigned a point value based on complexity and time.
...
The Payout Calculation:At the end of the month, the total dollar amount in the Developer Pool is divided by the total number of points earned by the whole team that month.

(Total Pool $) ÷ (Total Team Points) = Value of 1 Point.You are paid out based on the points you earned that month. 
...
Join our Discord: *Under Construction*
